...
<script type='text/javascript'>
	function getSection() {
		...
		window.location.replace("prof-lecture.jsp?secNum=" + secNum);
	};
</script>
</head>
<body>
			...
			<td
				...
				<div style="float: left;">
					...
					<select name="secNum" id='section' title="과목을 선택하여 주십시오">
						...
						border="0" align="absmiddle" onclick='getSection()'></a>
				</div>
			</td>
			<td
	...
	<table>
		<tr>
			<td class="btn011"></td>
			<td class="btn012" style="cursor: pointer;"><a
				href="prof-lecture-write.jsp">등록</a></td>
			<!--강의자료실 글쓰기-->
			<td class="btn013"></td>
		</tr>
	</table>
